...
var SearchExample = React.createClass({
    ...
    render: function() {
        ...
        return <div>
                    <input id="inputj" type="search" value={this.state.searchString} onChange={this.handleChange} placeholder="Digite uma palavra" />

                    <ta> 

                        { libraries.map(function(l){
                            return <tl><a href={l.url}><img src={l.src}/><h2 class="jname">{l.name}</h2><p class="jdescricao">{l.description}</p></a></tl>
                        }) }
